...
def main():
    ...
    for x in range(1, 56):
        ...
        # Sorts the remainders in order highest to lowest.
    ...
    for party_id, seats in overall_seats.items():
        ...
        cur.execute("INSERT INTO results VALUES ('Largest Remainder (by County)', ?, ?, ?, 0, 0.0)", (party_name[0], seats, (seats/650)*100))
